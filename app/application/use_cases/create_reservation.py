...
class CreateReservationUseCase:
    ...
    async def execute(
        ...
        customer_full_name = (
            f"{request.customer.first_name} {request.customer.last_name}"
        )
        ...
        reservation = ReservationModel(
            ...
            supplier_cost_total=request.total_amount * Decimal("0.8"),
        ...
        # We rely on the session commit in the controller/dependency to
        # save this update
